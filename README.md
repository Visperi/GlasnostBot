...
|           variable            | value type | function                                                                                                                                                                                                                                                                                                                      |
|:-----------------------------:|:----------:|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|   `display_message_sender`    |  Boolean   | Show the message sender in every message forwarded to Discord. Might be a little redundant if a channel or single user is listened. Does not affect "Forwarded from" notifications, which are always shown.                                                                                                                   |
