...
|           variable            | value type | function                                                                                                                                                                                                                                                                                                                      |
|:-----------------------------:|:----------:|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|   `display_message_sender`    |  Boolean   | Show the message sender in every message forwarded to Discord. Might be a little redundant if only one target is listened (e.g. Telegram channel or a single user). Does not affect "Forwarded from" notifications, which are always shown.                                                                                   |
